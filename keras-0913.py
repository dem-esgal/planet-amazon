...
import pandas as pd  # data processing, CSV file I/O (e.g. pd.read_csv)from skimage.feature import hog
...
for f, tags in tqdm(df_train.values, miniters=1000):
    ...
    x_train.append(transform.resize(img, (64, 64)))
    y_train.append(targets)

for f, tags in tqdm(df_test.values, miniters=1000):
    img = io.imread('../input/test-jpg-v2/{}.jpg'.format(f))
    x_test.append(transform.resize(img, (64, 64)))
...
df_test['tags'] = preds
df_test.to_csv('submission_keras913.csv', index=False)